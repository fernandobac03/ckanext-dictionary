...
class Data_DictionaryPlugin(p.SingletonPlugin):
    ...
    def before_map(self, map):
 	map.connect('add dataset', '/dataset/new',controller='ckanext.dictionary.controller:DDController', action='new_resource_ext')       
	...
	map.connect('add dataset', '/dataset/new', action='neww') 
